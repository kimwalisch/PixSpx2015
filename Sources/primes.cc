...
namespace primes{
  ...
  void init_presieve(int nbps) {
	...
	error();
      ...
      init_presieve(nbps);
      //cout << "init_prime_table : presieve_base set to " << primes::presieve_base << endl;
      T.create(upto, primes::presieve_base);
      primes_initialized = 1;
#ifdef DEBUG_PRIMES
      cout << "\nprime_table::is_created first non presieved prime = " << primes::prime(1) << endl;;
    ...
    void display() {
      cout << "\nPrime_table created\n";
      cout << "    number of presieved primes  = " << primes::number_of_presieve_primes << endl;
      cout << "    first non presieved prime   = " << primes::prime(1) << endl;;
      cout << "    primes::number_of_primes()  = " << primes::number_of_primes() << endl;
      cout << "    primes::max_prime()         = " << primes::max_prime() << endl << endl;
    }
